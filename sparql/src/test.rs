...
#[test_case("!(!\"foo\"@en)        ", ""; "bool lang-string non-empty")]
#[test_case("!(!\"foo\"@en--ltr)   ", ""; "bool dir-lang-string non-empty")]
#[test_case("!(!\"\"@en)           ", ""; "bool lang-string empty")]
#[test_case("!(!\"\"@en--ltr)      ", ""; "bool dir-lang-string empty")]
#[test_case("!(!\"x\"^^xsd:boolean)", ""; "bool ill-typed")]
...
#[test_case("langMatches(\"\", \"en\")", "false"; "langMatches for empty string")]
#[test_case("langMatches(\"en\", \"\")", "false"; "langMatches for empty string as range")]
#[test_case("langMatches(\"%\", \"en\")", "false"; "langMatches for invalid tag")]
#[test_case("langMatches(\"en\", \"%\")", "false"; "langMatches for invalid tag as range")]
